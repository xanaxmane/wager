...
return [
    ...
    'chat_commands' => [
        '/user' => 'Просмотр пользователя',
        '/bet' => 'Просмотр ставки',
        '/ignore' => 'Игнорировать пользователя',
        '/unignore' => 'Перестать игнорировать пользователя',
    ...
    'profile' => [
        'password_was_changed' => 'Пароль был изменен',
        'general' => 'Профиль',
        'login' => 'Логин',
        'password' => 'Пароль',
        ...
        'settings' => 'Настройки',
        'update' => 'Обновить',
        'verify_email' => 'Проверьте Email для его подтверждения!',
        'wager' => 'Оборот',
        'games' => 'Всего игр',
        ...
        'link' => 'Привязать',
        'linked' => 'Привязан',
        'somebody_already_linked' => 'Этот аккаунт социальной сети уже был привязан к другому аккаунту win5x.com',
...
//                         <br><br><a href='javascript:void(0)' onclick='$(\".notifications-overlay\").click(); $.vip();' class='disable-pjax'>Ознакомиться со всеми возможностями VIP статуса</a>"
    ...
    'lines' => 'Линии',
    'profit_per_line' => 'Ставка на линию',
    'invalid_amount_per_line' => 'Некорректное значение ставки на линию',
    'ignore' => 'Теперь вы игнорируете этого пользователя',
    'unignore' => 'Вы больше не игнорируете этого пользователя',
    'ignored_already' => 'Вы уже игнорируете этого пользователя',
    'not_ignored' => 'Вы не игнорируете этого пользователя',
    'not_available' => 'Недоступно',
    'obtained' => 'Выполнено',
    'hilo-skip' => 'Пропустить',
    'bets' => [
        'game' => 'Игра',
        'player' => 'Игрок',
        'time' => 'Время',
    ...
    'error' => [
        'invalid_password_confirm' => 'Пароли не совпадают',
        ...
        'wager' => 'Минимальная сумма ставки - 0.00000001',
    ...
    'stop' => 'Остановить',
    'overview' => 'Просмотр',
    'share_text' => 'Посмотрите мою игру на win5x.com!',
    ...
    'baccarat' => [
        ...
        'pair' => 'Пара',
        'banker' => 'Дилер',
        'empty' => 'Станьте первыми - сделайте ставку'
    ],
    'verify' => 'Проверить',
    'black' => 'Черный',
    'red' => 'Красный',
