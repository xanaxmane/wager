@if(isset($data))
    ...
    <div class="row page-title">
        <div class="col-md-12">
            ...
            <code>{{ $game->metadata()->id() }}/*{{ $game instanceof \App\Games\Kernel\Quick\QuickGame ? 'Quick' : ($game instanceof \App\Games\Kernel\Multiplayer\MultiplayerGame ? 'Multiplayer' : 'Extended')}}</code>
        </div>
    </div>
