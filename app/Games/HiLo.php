...
class HiLo extends ExtendedGame implements MultiplierCanBeLimited {
    ...
    public function turn(\App\Game $game, array $turnData): Turn {
        ...
        if($turnData['type'] === 'higher') $multiplier = (12.350 / (13 - ($current['slot'] - 1)));
        else if($turnData['type'] === 'lower') $multiplier = (12.350 / ($current['slot']));
        else if($turnData['type'] === 'same') $multiplier = 16.83;
